        ...
        <div id="sidebar-wrapper" class=" bg-dark">
            <div id="sidebar" class="bg-dark text-light">
                ...
                <ul class="nav nav-pills flex-column mb-auto " style="padding-top: 1px">
                    ...
                    <li>
                        <router-link to="/panel/brands" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/brands'}">
                            <i title="برند ها" class="bi bi-star-fill me-2"></i>
                            <span class="sidebar_title">برند ها</span>
                        </router-link>
                    </li>
                    <li>
                    ...
                    <li>
                        <router-link to="/panel/shops" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/shops'}">
                            <i title="فروشگاه ها" class="bi bi-shop-window me-2"></i>
                            <span class="sidebar_title">فروشگاه ها</span>
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/panel/grades" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/grades'}">
                            <i title="گرید ها" class="bi bi-bar-chart-fill me-2"></i>
                            <span class="sidebar_title">گرید ها</span>
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/panel/cities" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/cities'}">
                            <i title="شهر ها" class="bi bi-pin-map-fill me-2"></i>
                            <span class="sidebar_title">شهر ها</span>
                        </router-link>
                    </li>


                    <li>
                        <router-link to="/panel/visitors" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/visitors'}">
                            <i title="ویزیتور ها" class="bi bi-person-bounding-box me-2"></i>
                            <span class="sidebar_title">ویزیتور ها</span>
                        </router-link>
                    </li>
