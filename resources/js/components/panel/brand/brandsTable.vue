...
<!--                    </td>-->
                    <td>
                    <router-link :to="'/panel/brand/'+data.id">{{ data.title }}</router-link>
                </td>
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                            <li>
                                <router-link :to="'/panel/brand/'+data.id" class="dropdown-item"
                                             style="text-align: right !important">
                                    مشاهده
                                </router-link>
                                <router-link :to="'/panel/edit/brand/'+data.id"
                                             class="dropdown-item"
                                             style="text-align: right !important">
                                    ویرایش
                                </router-link>
