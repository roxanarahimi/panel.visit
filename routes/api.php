...
Route::controller(App\Http\Controllers\CityController::class)->group(function () {
    ...
    Route::get('/brand/{city}', 'show');
    Route::get('/latest/city', 'latestSite');
    Route::get('/article/by/city/{id}', 'byCat');
...
Route::controller(App\Http\Controllers\ShopController::class)->group(function () {
    ...
    Route::get('/shop', 'indexSite');
    Route::get('/shop/{shop}', 'show');
    Route::get('/latest/shop', 'latestSite');
    Route::get('/article/by/shop/{id}', 'byCat');
    ...
    Route::prefix('panel')->group(function () {
        ...
        Route::get('/delete/shop/{id}', 'destroy');

        Route::get('/active/shop/{shop}', 'activeToggle');
        Route::get('/latest/shop', 'latest');
    });
});
Route::controller(App\Http\Controllers\GradeController::class)->group(function () {

    Route::get('/grade', 'indexSite');
    Route::get('/grade/{grade}', 'show');
    Route::get('/latest/grade', 'latestSite');
    Route::get('/article/by/grade/{id}', 'byCat');
    ...
    Route::prefix('panel')->group(function () {
        ...
        Route::post('/grade/{grade}', 'update');
        Route::get('/delete/grade/{id}', 'destroy');

        Route::get('/active/grade/{grade}', 'activeToggle');
        Route::get('/latest/grade', 'latest');
    });
});
Route::controller(App\Http\Controllers\VisitorController::class)->group(function () {
    ...
    Route::prefix('panel')->group(function () {
        ...
        Route::get('/latest/visitor', 'latest');
    });
});
